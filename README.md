...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3840&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-mptt-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-mptt` can be installed with `conda`:
...
```
mamba install django-mptt
```

It is possible to list all of the versions of `django-mptt` available on your platform with `conda`:
...
```
mamba search django-mptt --channel conda-forge
```
...
mamba repoquery search django-mptt --channel conda-forge

# List packages depending on `django-mptt`:
mamba repoquery whoneeds django-mptt --channel conda-forge

# List dependencies of `django-mptt`:
mamba repoquery depends django-mptt --channel conda-forge
```
